...
const api = supertest(app) // Create a supertest instance
...
const usersInDb = async () => {
  ...
  return testUsers.map(user => user.toJSON())
}
...
module.exports = {
  biggerListOfBlogs, blogsInDb, usersInDb, testUsers, testloginAndGetToken
}